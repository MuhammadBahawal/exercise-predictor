        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <select id="gender" name="gender" required class="form-select">
                    <option value="" disabled <?php if (!isset($_POST['gender']))
                        echo 'selected'; ?>>Select Gender
                    </option>
            ...
            <div class="mb-3">
                ...
                <select id="activity" name="activity" required class="form-select">
                    <option value="" disabled <?php if (!isset($_POST['activity']))
                        echo 'selected'; ?>>Select Activity
                        Level
                    </option>
                    <option value="sedentary" <?php if (isset($_POST['activity']) && $_POST['activity'] == 'sedentary')
                        echo 'selected'; ?>>Sedentary
                        (little or no exercise)</option>
                    <option value="active" <?php if (isset($_POST['activity']) && $_POST['activity'] == 'active')
                        echo 'selected'; ?>>Active
                        (moderate exercise 3-5 days/week)</option>
                    <option value="very_active" <?php if (isset($_POST['activity']) && $_POST['activity'] == 'very_active')
                        echo 'selected'; ?>>Very
            ...
            <div class="mb-3">
                ...
                <select id="goal" name="goal" required class="form-select">
                    <option value="" disabled <?php if (!isset($_POST['goal']))
                        echo 'selected'; ?>>Select Goal</option>
                    <option value="weight_loss" <?php if (isset($_POST['goal']) && $_POST['goal'] == 'weight_loss')
                        echo 'selected'; ?>>Weight Loss
                    </option>
                    <option value="muscle_gain" <?php if (isset($_POST['goal']) && $_POST['goal'] == 'muscle_gain')
                        echo 'selected'; ?>>Muscle Gain
                    </option>
                    <option value="maintain" <?php if (isset($_POST['goal']) && $_POST['goal'] == 'maintain')
                        echo 'selected'; ?>>Maintain Weight
                    </option>
                </select>
            </div>
