...
<head>
    ...
    <style>
        ...
        .card-container {
            display: flex;
            flex-wrap: wrap;
            /* Allows cards to wrap into multiple rows */
        ...
        .card {
            ...
            color: #fff;
            width: 150%;
            /* Ensures 4 cards fit in one line */
            max-width: 250px;
            border: none;
            border-radius: 15px;
            overflow: hidden;
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                        ...
                        <img src="images/9027486_user_icon.png" alt="Profile" class="rounded-circle"
...
<div class="container">
    ...
    <div class="text-center">
        <a href="BMI.php" class="btn btn-bmi">Body Metrices</a>
    </div>
</div>
