...
<body>
    ...
    <div class="container">
        ...
        <form id="bmiForm" method="POST" onsubmit="return calculateBodyMetrics(event)">
            ...
            <div class="input-group">
                ...
                <input type="number" id="waist" name="waist" placeholder="Enter waist circumference" step="0.1"
                    required>
            </div>
    ...
    <script>
        ...
        function calculateBodyMetrics(event) {
            ...
            var bodyFat = 0;
            if (gender === 'male') {
                bodyFat = (86.010 * Math.log10(waist - neck) - 70.041 * Math.log10(height * 100) + 36.76).toFixed(2);
            } else {
                bodyFat = (163.205 * Math.log10(waist + hip - neck) - 97.684 * Math.log10(height * 100) - 78.387).toFixed(2);
            }
            ...
            // Get user_id from session (injected by PHP)
            ...
            xhr.send("weight=" + weight + "&bmi=" + bmi + "&body_fat_percentage=" + bodyFat);
        }
    </script>
