...
if ($last_logged !== $today) {
  ...
  $stmt->bind_param("iisis", $user_id, $current_streak, $today, $current_streak, $today);
  $stmt->execute();
  $stmt->close();
}
...
<body>
  ...
  <div class="badges-container">
    <?php foreach ($badges as $days => $badge):
      ...
      <div class="badge <?= $unlocked ? 'unlocked' : 'locked' ?>"
        title="<?= $badge['name'] ?> - Requires <?= $days ?> days streak">
  ...
  <br>
  <a href="HOME.php" class="btn-action" style="
