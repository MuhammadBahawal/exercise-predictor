    ...
    <main class="profile-container" role="main" aria-label="User profile details and update form">
        ...
        <form method="POST" action="profile.php" novalidate>
            <div class="mb-4">
                ...
                <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($user['name']); ?>"
                    disabled aria-disabled="true" />
            </div>

            <div class="mb-4">
                <label for="weight">Weight (kg)</label>
                <input type="number" id="weight" name="weight" value="<?php echo htmlspecialchars($user['weight']); ?>"
                    min="20" max="300" required aria-required="true" />
            </div>

            <div class="mb-4">
                <label for="height">Height (cm)</label>
                <input type="number" id="height" name="height" value="<?php echo htmlspecialchars($user['height']); ?>"
                    min="100" max="250" required aria-required="true" />
            </div>
        ...
        <div class="links">
            ...
            <a href="HOME.php" aria-label="Return to home page">Back to Home</a>
        </div>
